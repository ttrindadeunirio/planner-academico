...
O objetivo geral deste trabalho é desenvolver uma plataforma de planejamento acadêmico voltada para estudantes do ensino superior, que centralize informações críticas do semestre letivo. Objetivos específicos:
...
Integração com Sistemas Oficiais: O sistema não realizará sincronização automática com sistemas acadêmicos institucionais (os dados devem ser inseridos manualmente pelo usuário).
...
Limite de Faltas: Percentual máximo de ausências permitido (25%, conforme regra institucional adotada) antes da reprovação.
